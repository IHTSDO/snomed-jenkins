...
SNOMED_PROJECT_DEPLOY_CONFIG=$(fixStr "${LINEARR[7]}")
SNOMED_PROJECT_SLACK_CHANNEL=$(fixStr "${LINEARR[8]}")
SNOMED_PROJECT_NOTIFIED_USERS=$(fixStr "${LINEARR[9]}")
SNOMED_PROJECT_USES_BOM=$(fixStr "${LINEARR[10]}")
SNOMED_PROJECT_DEPENDENCIES=$(fixStr "${LINEARR[11]}")
SNOMED_PROJECT_OWNER=$(fixStr "${LINEARR[12]}")
SNOMED_PROJECT_NOTES=$(fixStr "${LINEARR[13]}")
...
export SNOMED_PROJECT_DEPLOY_CONFIG
